...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Questions with a pub_date in teh future aren't displayed on the index page.
        """
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False for questiosn whose pub_date is older than 1 day.
        """
